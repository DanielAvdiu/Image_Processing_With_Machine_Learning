...
if __name__ == "__main__":
    ...
    create_dir("attention_files_5")

    """ Hyperparaqmeters """
    batch_size = 4
    lr = 1e-4   ## 0.0001
    num_epochs = 100
    model_path = "attention_files_5/attention_model_better.h5"
    csv_path = "attention_files_5/attention_data_better.csv"
    ...
    """ Model """
    attention_model = build_unet((H, W, 3))
    metrics = [dice_coef, iou, Recall(), Precision()]
    attention_model.compile(loss="binary_crossentropy", optimizer=Adam(lr), metrics=metrics)
