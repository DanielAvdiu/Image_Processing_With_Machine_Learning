...
if __name__ == "__main__":
    ...
    create_dir("files_pruning_more")

    """ Hyperparaqmeters """
    batch_size = 8
    lr = 1e-4   ## 0.0001
    num_epochs = 100
    model_path = "files_pruning_more/model_pruned_more.h5"
    csv_path = "files_pruning_more/data_pruned_more.csv"
    ...
    final_model.save("model_pruned_more.h5")
