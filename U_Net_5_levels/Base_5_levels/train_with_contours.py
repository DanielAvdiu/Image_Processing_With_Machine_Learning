...
if __name__ == "__main__":
    ...
    create_dir("files_contours_01")

    """ Hyperparaqmeters """
    batch_size = 8
    lr = 1e-4   ## 0.0001
    num_epochs = 100
    model_path = "files_contours_01/model_contour_base_01.h5"
    csv_path = "files_contours_01/data_contour_base_01.csv"

    """ Dataset """
    dataset_path = "../../Augmented_contours/dataset_augmented_01/"
