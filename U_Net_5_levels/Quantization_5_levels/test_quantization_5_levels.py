...
def load_data(path, split=0.2):
    ...
    # Splitting the remaining data into train and validation sets
...
if __name__ == "__main__":
    create_dir("results_5_levels_02")
    interpreter = tf.lite.Interpreter(model_path="./files_quantized_5_levels_02/model.tflite",
    ...
    """ Dataset """
    dataset_path = "../../DSB_small_dataset/"
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        save_path = f"./results_5_levels_02/{name}"
    ...
    df.to_csv("files_quantized_5_levels_02/score_quantized_5_levels_02.csv")
