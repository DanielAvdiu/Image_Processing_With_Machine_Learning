...
if __name__ == "__main__":
    ...
    create_dir("files_quantized_5_levels_02")

    # Hyperparameters
    batch_size = 4
    lr = 1e-4
    num_epochs = 1
    model_path = "files_quantized_5_levels_02/model_quantized_5_levels_02.h5"
    tf2onnx_model_path = "files_quantized_5_levels_02/model_quantized.onnx"
    csv_path = "files_quantized_5_levels_02/data_quantized_5_levels_02.csv"
    ...
    # Convert the quantized model to tf2onnx format
    tf2onnx.convert.from_keras(quant_aware_model, input_signature=None, opset=11, output_path=tf2onnx_model_path)
