...
if __name__=="__main__":
    create_dir("results_attention")

    """ Load Model """
    with CustomObjectScope({'iou':iou, 'dice_coef':dice_coef}):
        model=tf.keras.models.load_model("attention_files/attention_model.h5")
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        save_path=f"./attention_files/{name}"
    ...
    df.to_csv("attention_files/score_attention.csv")